      ...
      <div className="max-w-7xl mx-auto">
        ...
        {alphabets.length === 0 && (
          ...
          >
            ...
            <h3 className="text-3xl font-bold text-white mb-4">Ready to Start Tallying?</h3>
            <p className="text-xl text-slate-300 mb-8 max-w-md mx-auto">
              Click "Add Alphabet" to create your first flash card and begin tracking sign language letters
            </p>
        ...
        {alphabets.length > 0 && (
          ...
          >
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl px-8 py-6 border border-white/10 inline-block">
